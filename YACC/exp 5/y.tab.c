...
static const char *const yytname[] =
{
  ...
  "$accept", "program", "declarations", "declaration", "assignment", 0
};
#endif
...
#line 104 "q5.y"
    {
          checkAssignment((yyvsp[(1) - (4)].str), (yyvsp[(3) - (4)].str));
      }
    break;
